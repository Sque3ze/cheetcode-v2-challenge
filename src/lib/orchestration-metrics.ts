...
const CRITICAL_CHAINS: string[][] = [
  ...
  ["tier1-form-fill", "tier2-linked-data-lookup", "tier3-constraint-solver", "tier4-red-herring"],
  ...
  ["tier1-tab-navigation", "tier2-sequential-calculator", "tier3-data-dashboard", "tier4-calculation-audit"],
  ["tier1-filter-search", "tier2-config-debugger", "tier4-calculation-audit"],
